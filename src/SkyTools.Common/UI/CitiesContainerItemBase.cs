...
namespace SkyTools.UI
{
    ...
    public abstract class CitiesContainerItemBase : IContainerViewItem
    {
        ...
        public void Translate(ILocalizationProvider localizationProvider)
        {
            ...
            TranslateCore(localizationProvider);
        }
        ...
        protected abstract void TranslateCore(ILocalizationProvider localizationProvider);
    }
}
