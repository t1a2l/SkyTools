...
namespace SkyTools.UI
{
    ...
    public abstract class CitiesViewItem<TItem, TValue> : IViewItem, IValueViewItem
        where TItem : UIComponent
    {
        ...
        protected TValue Value
        {
            get
            {
                ...
                {
                    Log.Error($"Failed to read a configuration value, error message: {ex}");
                    return default;
                }
            }
            ...
            private set
            {
                ...
                {
                    Log.Error($"Failed to update a configuration value, error message: {ex}");
                }
            }
        }
